...
export const DashboardIns = () => {
    ...
    useEffect(() => {
        controlApi.get('/registerUsers/single?id=1')
            .then(() =>{
            ...
            <Dashboard>
                    <>
                        <div className='cardBox'>
                            <div className='card'>
                                <div>
                                    <div className='title'>Inscripción</div>
                                    ...
                                    >
                                        {
                                            ()=>(
                                                <Form>
                                                    <h2 style={{marginBottom: '20px'}}>Formulario de Inscripcion</h2>
